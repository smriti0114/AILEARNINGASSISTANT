            ...
            <form onSubmit={handleUpload} className="sapce-y-5">
              ...
              <div className="flex gap-3 pt-2">
                ...
                <button
                  type="submit"
                  disabled={uploading}
                  className="flex-1 h-11 px-4 bg-linear-to-r from-emerald-500 to-teal-500 hover:from-emerald-600 hover:to-teal-600 text-white text-sm font-semibold rounded-xl transition-all duration-200 shadow-lg shadow-emerald-500/25 disbaled:opacity-50 disabled:cursor-not-allowed active:scale-[0.98]"
                >
                  {uploading ? (
      ...
      {isDeleteModalOpen && (
        ...
        <div className="relative w-full max-w-md bg-white/95 backdrop-blur-xl border border-slate-200/60 rounded-2xl shadow-2xl shadow-slate-900/20 p-8">
          ...
          <p className="text-sm text-slate-600 mb-6">
            ...
            <span className="font-semibold text-slate-900">{selectedDoc?.title}</span>? This action cannot
            be undone.
          </p>
